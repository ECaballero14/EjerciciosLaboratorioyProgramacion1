...
int main()
{
    ...
    setBook(bookArray,1,1,"What you need before you can learn C",1);
    setBook(bookArray,2,2,"Using a Compiler",2);
    setBook(bookArray,3,3,"A Taste of C",3);
    setBook(bookArray,4,4,"Why Learn C",1);
    ...
    while(option != 6)
    {
         ...
         switch(option)
         {
            case 1: // ALTA DE LIBRO
                ...
                setBook(bookArray,freePlaceIndex,codeAux,titleAux,authorIdAux);
            ...
            case 3: // MODIFICAR LIBRO
                ...
                setBook(bookArray,foundIndex,codeAux,titleAux,authorIdAux);
